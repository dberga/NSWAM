function [img_out] = NCZLd_channel_v1_0(img_in,struct,channel,nstripes)
...
disp(strcat('Scales al entrar a la funcio channel_v1_0: ', num2str(n_scales)));
...
disp('Ha entrat a la funcio NCZLd_channel_v1_0');
...
save([image.name '_eCSF' channel 'nstripes' num2str(nstripes) '.mat'],'eCSF');
