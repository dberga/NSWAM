...
cortex_elong2pix = cortex_width/cortex_max_elong;
cortex_az2pix = cortex_height/cortex_max_az;
...
j = round((coord_j_cortex*cortex_elong2pix)+cortex_width_2+1);
i = round((coord_i_cortex*cortex_az2pix)+cortex_height_2+1);
