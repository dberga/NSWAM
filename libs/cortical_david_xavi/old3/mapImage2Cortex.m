function [cortex] = mapImage2Cortex(img,img_diag_angle,cortex_width, cortex_height, fov_x, fov_y)
...
[coord_i_eye, coord_j_eye] = cortex2eye( (coord_j_cortex-1-cortex_width_2)*cortex_pix2elong, (coord_i_cortex-1-cortex_height_2)*cortex_pix2az);
