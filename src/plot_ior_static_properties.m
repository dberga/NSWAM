...
ior_type='static';
switch ior_type
    case 'static' %itti & koch (saliency map - ior)
        ...
        %     ior_decay_default=[0 .25 .5 .75 nthroot(0.001,(1:10)*100) 1];
            ior_decay_default=[nthroot(0.001,(1:10)*100)];
        end
    ...
    case 'scanpath' %ours (inhibitory +ior term)
        models_beta={'no_ior_config_15_b1_m12_after_sqmean_fusion2_invdefault','ior_beta100_sigma1_scanpath_config_15_b1_m12_after','ior_beta100_sigma2_scanpath_config_15_b1_m12_after','ior_beta100_sigma4_scanpath_config_15_b1_m12_after','ior_beta100_sigma8_scanpath_config_15_b1_m12_after'};
        models_alpha={'no_ior_config_15_b1_m12_after_sqmean_fusion2_invdefault','ior_beta93_sigma2_scanpath_config_15_b1_m12_after','ior_beta96_sigma2_scanpath_config_15_b1_m12_after','ior_beta98_sigma2_scanpath_config_15_b1_m12_after','ior_beta99_sigma2_scanpath_config_15_b1_m12_after','ior_beta100_sigma2_scanpath_config_15_b1_m12_after'};
end
