...
%[ loaded_struct_equivalent ] = get_samemat( mat_props.loaded_struct_path{k} );
%if exist(get_mat_name('iFactor',folder_props,image_props,gaze_idx,loaded_struct.color_params.channels{c}),'file')
