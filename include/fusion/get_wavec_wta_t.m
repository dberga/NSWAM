function [ RFmax_c,residualmax_c, max_s, max_o, max_c , max_x, max_y] = get_wavec_wta_t( RF_s_o_c, residual_s_c, n_scales, n_orient, C )
    ...
    for c=1:C
        ...
        RFmax_c(:,:,c) = RF_s_o_c{max_s}{max_o}(:,:,c);
        residualmax_c(:,:,c) = residual_s_c{max_s}(:,:,c);
    end
