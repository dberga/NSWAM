...
% 		  curv_final{ff}{scale}{orient}=iFactor(:,:,ff);
	  end
...
if plot_wavelet_planes==1 
    ...
    subplot(1,3,3),imagesc(curv_final{n_iter}{scale}{orient});colormap('gray');
%      subplot(1,3,2),imagesc(generate_csf(curv_final{ff}{scale}{orient},scale,zli.nu_0,'intensity'));colormap('gray');
%     subplot(1,3,3),imagesc(curv{n_iter}{scale}{orient}.*generate_csf(curv_final{ff}{scale}{orient},scale,zli.nu_0,'intensity'));colormap('gray')*0.5;
end    
