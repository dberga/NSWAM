...
% Mach bands
load('mach_256_min_freq_32_epsilon_1.3_kappay_1.25_normal_output_2_img.mat')
load('mach_256_min_freq_32_epsilon_1.3_kappay_1.25_normal_output_2_img_out.mat')
% input
img1=img(1:128,:,:);
