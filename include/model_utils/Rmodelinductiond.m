...
% 			Delta=zli_params.Delta*2.^((1:n_scales)-1);
               if zli_params.bScaleDelta
                    Delta=zli_params.Delta*ceil(scale2size(1-(log2(32)-log2(wave_params.mida_min)):n_scales-(log2(32)-log2(wave_params.mida_min)),zli_params.scale2size_type,zli_params.scale2size_epsilon));
               else
                   Delta=zli_params.Delta*ones(1,n_scales);
               end
		end
...
[M_norm_conv,inv_den]=Fer_M_norm_conv(n_scales,dist_type,zli_params.scale2size_type,zli_params.scale2size_epsilon,zli_params.bScaleDelta,wave_params.mida_min);
...
%             radi=round([Delta(s)-1 Delta(s)-1]);
